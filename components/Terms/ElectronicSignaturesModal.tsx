  ...
  return (
    <div className="es-modal-container">
      <div className="es-modal-content-container">
        ...
        <p className="es-modal-text">
          In order to use Electronic signatures and Records and retain the electronic
        ...
        <ul className="es-modal-text">
          ...
          <li>
            For website-based Communications, a current web browser that supports 128-bit
            encryption. Minimum recommended browser standards are Microsoft Internet Explorer
            version 11.0 and above (see{" "}
            <a href="http://www.microsoft.com/ie" target="_blank" rel="noopener noreferrer">
            ...
            <a href="http://www.mozilla.com" target="_blank" rel="noopener noreferrer">
          ...
          <li>
            A printer that is capable of printing from your Internet browser and email software, if
            you desire paper copies of your records.
          </li>
          <li>
            An application that can view, save and print PDF files (such as Adobe Reader). You can
            download a copy of Adobe Reader here:{" "}
